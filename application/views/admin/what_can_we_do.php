	...
	<div class="col-md-12">
      <div class="box box-default collapsed-box">
        ...
        <div class="box-body" style="display: none;">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="<?php echo base_url('dashboard/what_can_we_do/edit');?>" enctype="multipart/form-data" accept-charset="utf-8" method="post" class="form-horizontal">
              <div class="box-body">
		...
		<div class="box">
            ...
            <div class="box-body">
              <table class="table table-bordered">
                ...
                <tbody id="sortable">
                <?php foreach($what_can_we_do as $row):?>
                <tr id="<?php echo $row['id'];?>">
                  ...
                  <td><a class="btn btn-danger btn-sm category_delete" href="<?php echo base_url('dashboard/what_can_we_do/delete/'.$row['id']);?>">Delete</a></td>
                </tr>
            	<?php endforeach;?>
...
<?php foreach ($what_can_we_do as $srv):?>  
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModalSlider_<?php echo $srv['id'];?>" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form enctype="multipart/form-data" accept-charset="utf-8" method="post" role="form" class="form-horizontal" action="<?php echo base_url('dashboard/what_can_we_do/edit')?>">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-success">Edit This</button>
            </div>
            </form>                                        
        </div>
    </div>
...
<?php endforeach;?>
<input type="hidden" id="table" value="what_can_we_do">