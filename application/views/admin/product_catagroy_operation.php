<div class="box box-info">
      <div class="box-header with-border">
        <h3 class="box-title"><?= (isset($product_catagroy[0])) ? $product_catagroy[0]['title'] : ''; ?></h3>
      </div>
      <!-- /.box-header -->
      <!-- form start -->
      <form id="page_banner_frm" action="<?php echo base_url('dashboard/product_catagroy/operation');?>" enctype="multipart/form-data" accept-charset="utf-8" method="post" class="form-horizontal">
        <div class="box-body">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
                <input value="<?= (isset($product_catagroy[0])) ? $product_catagroy[0]['title'] : ''; ?>" required id="title" name="title" type="text" class="form-control">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
                <input value="<?= (isset($product_catagroy[0])) ? $product_catagroy[0]['sort_details'] : ''; ?>" required id="sort_details" name="sort_details" type="text" class="form-control">
            </div>
          </div>
        ...
        <input id="id" type="hidden" name="id" value="<?= (isset($product_catagroy[0])) ? $product_catagroy[0]['id'] : ''; ?>" />
